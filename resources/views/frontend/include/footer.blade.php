@if(!request()->is('student/*'))
    ...
    <!-- ================================
           Start FOOTER AREA
  ================================= -->
    <section class="footer-area section-bg-2 padding-top-40px padding-bottom-40px {{ request()->is('student/*') ? 'student-dashboard' : '' }}">
        <div class="container">
            <div class="row">
                <div class="{{ request()->is('student/*') ? 'col-lg-3 offset-md-2' : 'col-lg-4' }} column-td-half">
                    <div class="footer-widget">
                        ...
                        <ul class="social-profile">
                             @if(getSystemSetting('type_whatsapp')->value != null)
                                <li><a href="{{getSystemSetting('type_whatsapp')->value}}" target="_blank"><i
                                            class="fa fa-whatsapp"></i></a></li>
                            @endif
                            @if(getSystemSetting('type_insta')->value != null)
                                <li><a href="{{getSystemSetting('type_insta')->value}}" target="_blank"><i
                            ...
                            @if(getSystemSetting('type_yt')->value != null)
                                <li><a href="{{getSystemSetting('type_yt')->value}}" target="_blank"><i
                ...
                <div class="{{ request()->is('student/*') ? 'col-lg-3' : 'col-lg-4' }} column-td-half">
                    <div class="footer-widget">
                        ...
                        <span class="fiooter-section-divider"></span>
                        <ul class="list-items">
