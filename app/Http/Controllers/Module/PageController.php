...
//create form
    ...
    {
        $content = PageContent::where('page_id', $id)->with('pages')->get();
    ...
    /*Content Create*/
    public function apiContentStore(Request $request)
    {
        ...
        $content = PageContent::firstOrNew(['page_id' =>  $request->page_id]);
        $content->page_id = $request->page_id;
        $content->title = $request->title;
        $content->body = $request->body;
