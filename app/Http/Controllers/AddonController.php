...
class AddonController extends Controller
{
    ...
    public function addonRemove($addon_name)
    {
        ...
        switch ($addon_name) {
            case 'zoom':
                try {
                    ...
                    //  /addons/zoom/controllers
                    $controller_to_path = base_path() . '/app/Http/Controllers/ZoomController.php'; // Coping to folder Path
                    File::delete($controller_to_path);
                    ...
                    //  /addons/zoom/Model/Zoom.php
                    $zoom_model_to_path = base_path() . '/app/Zoom.php'; // Coping to folder Path
                    File::delete($zoom_model_to_path);


                    //  /addons/zoom/routes/zoom.php
                    $meeting_model_to_path = base_path() . '/app/Meeting.php'; // Coping to folder Path
                    File::delete($meeting_model_to_path);
                    ...
                    //  /addons/zoom/views/zoom
                    $zoom_dashboard_to_path = base_path() . '/resources/views/zoom'; // Coping to folder Path
                    File::deleteDirectory($zoom_dashboard_to_path);

                    /**
                     * views/zoom:END
                     */

                    $addon_folder = base_path() . '/addons/zoom'; // Coping to folder Path
                    File::deleteDirectory($addon_folder);
                    ...
                    Alert::toast(translate('success'), translate('Package Removed'));
                    return redirect()->route('addons.manager.index');

                } catch (\Throwable $th) {
                    Alert::toast(translate('Package Remove Failed'), translate('error'));
                    return back();
                }
                break;
                ...
                try {
                    ...
                    Addon::where('name', 'quiz')->delete();
                        ...
                        $question_model_to_path = base_path() . '/app/Question.php'; // Coping to folder Path
                        File::delete($question_model_to_path);

                        $quiz_model_to_path = base_path() . '/app/Quiz.php'; // Coping to folder Path
                        File::delete($quiz_model_to_path);

                        $quizscore_model_to_path = base_path() . '/app/QuizScore.php'; // Coping to folder Path
                        File::delete($quizscore_model_to_path);
                        ...
                        //  /addons/zoom/views/zoom
                        $quiz_dashboard_to_path = base_path() . '/resources/views/addon/view/quiz'; // Coping to folder Path
                        File::deleteDirectory($quiz_dashboard_to_path);

                        /**
                         * views/zoom:END
                         */

                        $addon_folder = base_path() . '/addons/quiz'; // Coping to folder Path
                        File::deleteDirectory($addon_folder);
                ...
                case 'paytm':
                    ...
                    try {
                        ...
                        $addon_folder = base_path() . '/addons/paytm'; // Coping to folder Path
                        File::deleteDirectory($addon_folder);
                        ...
                        overWriteEnvFile('PAYTM_ENVIRONMENT', '');
                        overWriteEnvFile('PAYTM_MERCHANT_ID', '');
                        overWriteEnvFile('PAYTM_MERCHANT_KEY', '');
                        overWriteEnvFile('PAYTM_MERCHANT_WEBSITE', '');
                        overWriteEnvFile('PAYTM_CHANNEL', '');
                        overWriteEnvFile('PAYTM_INDUSTRY_TYPE', '');
                        overWriteEnvFile('PAYTM_ACTIVE', 'NO');
                ...
                case 'forum':
                    ...
                    try {
                        ...
                        File::delete($forum_controller_to_path);
                        ...
                        File::delete($forum_route_to_path);
                        ...
                        File::deleteDirectory($forum_dashboard_to_path);

                        /**
                         * views/zoom:END
                         */

                        $addon_folder = base_path() . '/addons/forum'; // Coping to folder Path
                        File::deleteDirectory($addon_folder);
                ...
                case 'certificate':
                    ...
                    try {
                        ...
                        Addon::where('name', 'certificate')->delete();
                        ...
                        File::deleteDirectory($certificate_dashboard_to_path);

                        /**
                         * views/certificate:END
                         */

                        $addon_folder = base_path() . '/addons/certificate'; // Coping to folder Path
                        File::deleteDirectory($addon_folder);
                ...
                case 'subscription':
                     ...
                     try {
                        ...
                        Addon::where('name', 'subscription')->delete();
                        ...
                        File::delete($subscription_controller_to_path);
                        ...
                        File::delete($subscription_route_to_path);
                        ...
                        File::deleteDirectory($subscription_dashboard_to_path);

                        /**
                         * views/subscription:END
                         */

                        $addon_folder = base_path() . '/addons/subscription'; // Coping to folder Path
                        File::deleteDirectory($addon_folder);
                ...
                case 'coupon':
                     ...
                     try {
                        ...
                        Addon::where('name', 'coupon')->delete();
                        /**
                         * Move Files to Folder
                         */
                        ...
                        File::delete($coupon_controller_to_path);
                        ...
                        File::delete($coupon_model_to_path);
                        ...
                        File::delete($coupon_route_to_path);
                        ...
                        $coupon_dashboard_to_path = base_path() . '/resources/views/coupon'; // Coping to folder Path
                        File::deleteDirectory($coupon_dashboard_to_path);

                        /**
                         * views/subscription:END
                         */

                        $addon_folder = base_path() . '/addons/coupon'; // Coping to folder Path
                        File::deleteDirectory($addon_folder);
                ...
                case 'wallet':
                     ...
                     try {
                        ...
                        Addon::where('name', 'wallet')->delete();
                        ...
                        File::delete($wallet_controller_to_path);
                        ...
                        File::delete($wallet_model_to_path);
                        ...
                        File::delete($RedeemCoursePoint_to_path);
                        ...
                        File::delete($wallet_route_to_path);
                        ...
                        $wallet_dashboard_to_path = base_path() . '/resources/views/wallet'; // Coping to folder Path
                        File::deleteDirectory($wallet_dashboard_to_path);

                        /**
                         * REMOVE FROM ADDON FOLDER
                         */

                        $addon_folder = base_path() . '/addons/wallet'; // Coping to folder Path
                        File::deleteDirectory($addon_folder);
                        /**
                         * views/wallet:END
                         */
                        ...
                        overWriteEnvFile('WALLET_ACTIVE', 'NO');
