...
Route::group(['middleware' => ['installed', 'checkBackend', 'auth', 'activity'], 'prefix' => 'dashboard'], function () {
    ...
    Route::get('instructor/create/modal', 'Instructor\InstructorController@create')->name('instructor.create.modal');
    Route::post('instructor/create/modal/store', 'Instructor\InstructorController@instructor_store')->name('instructor.store.modal');
